...
const InputComponent = ({
  ...
  return (
    <div className="flex flex-col justify-center gap-2">
      <div className="flex h-6 items-center font-sans text-xl font-semibold text-black">
        {title}
      </div>
      {options ? (
        <select
          ...
          value={value}
          onChange={onChange}
          className="cursor-pointer border-b border-none border-[#b3b3b3] bg-transparent p-[13.5px_8px] font-sans text-[18px] text-[#b3b3b3] backdrop-blur-[50px] outline-none focus:text-black"
        >
          ...
          {options.map((option: string, idx: number) => (
            <option
              key={idx}
              value={option}
              className="bg-[#f4f4f4] text-center text-[18px] font-semibold text-[#4d4d4d]"
            >
              {option}
            </option>
          ))}
        ...
        <input
          ...
          value={value}
          onChange={onChange}
          className="h-12 w-full border-b border-none border-[#b3b3b3] p-[14.5px_8px] font-sans text-base text-black outline-none placeholder:font-semibold placeholder:text-[#b3b3b3]"
        />
      )}
    </div>
  );
