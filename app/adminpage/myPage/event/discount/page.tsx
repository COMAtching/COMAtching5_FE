  ...
  return (
    <div className="min-h-screen bg-[#f4f4f4] font-sans">
      ...
      <main className="p-6 md:px-[max(5vw,20px)] flex flex-col items-center gap-6">
        <div className="bg-white rounded-[24px] border border-white/30 shadow-[1px_1px_20px_rgba(196,196,196,0.3)] w-full p-6 flex flex-col gap-2">
          <div className="text-[32px] font-bold text-black">포인트 충전 할인 이벤트 예약</div>
        </div>
        ...
        <div className="bg-white rounded-[24px] border border-white/30 shadow-[1px_1px_20px_rgba(196,196,196,0.3)] w-full p-6 flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            <div className="text-[32px] font-bold text-black">이벤트 시간설정(최대 2시간)</div>
            ...
            <div className="flex flex-col gap-4 mt-4 border-t border-gray-100 pt-6">
              <div className="text-2xl font-semibold text-black">
                교내 가입자 전원에게 <span className="text-[#ff4d61]">{getDurationText()}동안 최대 3번 구매 가능한</span>
              </div>
              <div className="flex flex-wrap items-center gap-4">
                <AdminDropdown options={percentages} selectedValue={selectedDiscount} onSelect={setSelectedDiscount} />
                <div className="text-2xl font-semibold">
                  %의 <span className="text-[#ff4d61]">포인트 충전 할인</span>을 제공합니다.
                </div>
              </div>
            </div>
            ...
            <button 
              ...
              className="w-[120px] h-12 bg-[#dd272a] text-white text-xl font-bold rounded-lg shadow-md hover:bg-red-700 transition-colors self-end"
            >
              확인
            </button>
          </div>
