  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-xs leading-[14px] font-semibold whitespace-nowrap text-[#454545]">
          채팅
        </span>
        {/* 배지 영역을 항상 렌더링하고 너비/스케일/투명도를 동시 트랜지션 처리하여 좌우 흔들림 완벽 제거 */}
        <div
          className={cn(
            "typo-10-500 flex h-4 shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#FF4D61] leading-[110%] font-semibold text-white transition-all duration-300",
            isMounted && hasUnread
