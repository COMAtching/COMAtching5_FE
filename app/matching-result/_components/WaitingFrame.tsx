...
const WaitingFrame = () => {
  return (
    <div className="mt-6 flex h-[200px] w-full flex-col items-center gap-2.5 rounded-3xl border border-white/30 bg-white/50 p-6 shadow-[0px_0px_8px_rgba(0,0,0,0.08)] backdrop-blur-[50px]">
