...
export const SelectCheckButton = ({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`${marginClassName} typo-14-400 flex h-5 w-5 items-center justify-center rounded-full border leading-none ${
        isSelected
      ...
      <div className="flex justify-center">
        {selected === "default" ? (
          ...
          >
            <button
              type="button"
              className="typo-14-600 flex h-[33px] items-center justify-center gap-2.5 rounded-[99px] bg-[#E5E5E5] px-4 py-2 leading-[17px] tracking-[-0.03em] text-[#4D4D4D]"
            >
              {actionLabel}
            </button>
          </DefaultProfileDrawer>
          ...
          <label
            ...
            className="typo-14-600 flex h-[33px] cursor-pointer items-center justify-center gap-2.5 rounded-[99px] bg-[#E5E5E5] px-4 py-2 leading-[17px] tracking-[-0.03em] text-[#4D4D4D]"
          >
            {actionLabel}
            <input
