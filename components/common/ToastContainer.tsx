...
export default function ToastContainer() {
  ...
  return (
    ...
    >
      <div className="rounded-5 flex w-full cursor-pointer items-start gap-3 border border-gray-100 bg-white/95 p-4 shadow-[0px_10px_30px_rgba(0,0,0,0.15)] backdrop-blur-md transition-transform active:scale-[0.98]">
        ...
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-tr from-[#FF775E] to-[#E83ABC] p-[1.5px]">
          <div className="rounded-2.5 flex h-full w-full items-center justify-center bg-white">
            <Image
              src="/logo/icon.png"
              alt="COMAtching"
              width={22}
