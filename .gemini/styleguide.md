...
- **CRITICAL: You MUST write ALL comments, feedback, suggestions, and code reviews EXCLUSIVELY in Korean (한국어).**
- **절대로 영어로 답변하지 마세요. 모든 코드 리뷰, 피드백, 제안사항은 반드시 한국어로 작성해야 합니다.**
